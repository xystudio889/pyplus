...
版本类型 `r` 意思是发布版.他会存放正式版。

版本类型 `pre` 意思是预发布版，他会存放测试版，他会有较多的bug。

版本类型 `rc` 意思是发布版即将到来，他会存放晚期测试，并在不久后发布正式版。他会有较少的bug
...
---
## 下载库
执行 `python setup.py install` 以下载此库。
